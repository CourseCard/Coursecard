...
import { MapPin, Flag, Globe, ChevronDown, ChevronUp, Check, ArrowLeft } from 'lucide-react';
...
export default function CourseCard() {
  ...
  function getFullCountryName(shortName) {
    const countryMap = {
      ...
      'French Gui': 'French Guiana',
      'Burkina Fa': 'Burkina Faso',
      'Bosnia-Her': 'Bosnia and Herzegovina',
      'Czech Repu': 'Czech Republic',
      'Netherland': 'Netherlands',
      'New Zealan': 'New Zealand',
      'North Mace': 'North Macedonia',
      ...
      'United Ara': 'United Arab Emirates',
  ...
  async function loadInitialData() {
    try {
      const fileData = await window.fs.readFile('GarminCourse_290125_v2.xlsx');
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          >
            ...
            <div className={viewMode === 'played' ? 'text-white' : 'text-green-600'}>
              Played Courses
            </div>
          ...
          >
            ...
            <div className={viewMode === 'wishlist' ? 'text-white' : 'text-blue-600'}>
              Wishlist
            </div>
